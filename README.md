...
Deploying
<p align="center"><img src="img/deploy.png" width="500"></p>


Finish deployment of clusters
<p align="center"><img src="img/Finish deployment of clusters.png" width="500"></p>
...
<p align="center"><img src="img/Karmada-Push.png" width="500"></p>
...
2. Set up Karmada-Push:
   ...
   ./01_karmada_push.sh
   ```
    <p align="center"><img src="img/karmada_push_finsih.png" width="500"></p>

    <p align="center"><img src="img/joinok.png" width="500"></p>
3. Verify the deployment
    ```bash
   ./02_check.sh
   ```

<p align="center"><img src="img/chekced.png" width="500"></p>
