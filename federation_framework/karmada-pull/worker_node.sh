...
mv /root/exprbs/edgesys/karmada-pull/metrics_server.yaml /root/
cp /root/exprbs/edgesys/karmada-pull/node_list /root/
cp /root/exprbs/edgesys/karmada-pull/patch.sh /root/
