...
mv /root/edgesys-2025/federation_framework/karmada-push/metrics_server.yaml /root/
cp /root/edgesys-2025/federation_framework/karmada-push/node_list /root/
cp /root/edgesys-2025/federation_framework/karmada-push/patch.sh /root/
