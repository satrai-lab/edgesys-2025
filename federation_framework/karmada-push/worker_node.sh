...
mv /root/exprbs/edgesys/karmada-push/metrics_server.yaml /root/
cp /root/exprbs/edgesys/karmada-push/node_list /root/
cp /root/exprbs/edgesys/karmada-push/patch.sh /root/
